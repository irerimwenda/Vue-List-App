        ...
        <sweet-modal ref="listModal" overlay-theme="dark">
            ...
            <form @submit.prevent="editmode ? updateList() : saveList()">
                ...
                <input v-model="form.list_title" type="text" name="list_title"
                    class="form-control" :class="{ 'is-invalid': form.errors.has('list_title') }">
                <has-error :form="form" field="list_title"></has-error>
                </div>

                <div class="form-group">
                <label>List Notes (Optional)</label>
                <textarea v-model="form.list_notes" name="list_notes" id="list_notes" rows="5"
                    class="form-control" :class="{ 'is-invalid': form.errors.has('list_notes') }">
                </textarea>
